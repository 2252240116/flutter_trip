...
class Flight extends Object {
  ...
  Flight(this.endColor,this.item1,this.item2,this.item3,this.item4,this.mainItem,this.startColor,);
...
class Item1 extends Object {
  ...
  Item1(this.hideAppBar,this.title,this.url,);
...
class MainItem extends Object {
  ...
  MainItem(this.icon,this.title,this.url,);
